...
class AppConfig(BaseModel):
    ...
    data_root: Path = DEFAULT_NTSB_SOURCE_ROOT
    sqlite_path: Path = DEFAULT_NTSB_SOURCE_ROOT / "acquisition" / "state" / "acquisition.db"
    downstream_raw_root: Path = DEFAULT_NTSB_SOURCE_ROOT / "raw"
    log_level: str = "INFO"
